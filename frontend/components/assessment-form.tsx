...
import { fieldDefinitions } from "@/lib/model-fields";
          ...
          <div className="flex bg-slate-100 rounded-md p-1">
            {field.options.map((opt: any) => (
              <label key={opt.value} className="relative flex-1 text-center cursor-pointer">
                ...
                />
                <div className="py-2 text-sm text-slate-600 rounded-md peer-checked:bg-white peer-checked:shadow-sm peer-checked:text-slate-900 transition-all">
                  {opt.label}
                </div>
              </label>
            ))}
    ...
    return (
      <div className="mb-4">
        ...
        <input 
          ...
          className="w-full border border-slate-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors"
